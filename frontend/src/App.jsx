    ...
    <div className="app-shell">
      ...
      <main className="main-content">
        ...
        <div className="content-wrap">
          {activeView === 'Overview' && <section className="welcome"><div><h1>Hello, Admin <span>✦</span></h1><p className="subhead">Here is what is happening across your people operations.</p></div><button className="primary-button" onClick={openEmployeeModal}>＋ Add employee</button></section>}
          {activeView === 'Overview' ? <>
